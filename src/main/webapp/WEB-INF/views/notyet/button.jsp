									...
									<div class="list list-hover">
										...
										<div class="list-item hoverable p-2 p-lg-3 mb-2">
											<div class="d-flex align-items-center">
												...
												<div class="symbol symbol-40 symbol-light mr-4">
													<span class="symbol-label bg-hover-white">
														<img src="${pageContext.request.contextPath}/resources/assets/media/svg/misc/010-vimeo.svg" class="h-50 align-self-center" />
													</span>
												</div>
												<!--end::Symbol-->
												<!--begin::Text-->
										...
										<div class="list-item hoverable p-2 p-lg-3 mb-2">
											<div class="d-flex align-items-center">
												...
												<div class="symbol symbol-40 symbol-light mr-4">
													<span class="symbol-label bg-hover-white">
														<img src="${pageContext.request.contextPath}/resources/assets/media/svg/misc/009-hot-air-balloon.svg" class="h-50 align-self-center" />
													</span>
												</div>
												<!--end::Symbol-->
												<!--begin::Text-->
										...
										<div class="list-item hoverable p-2 p-lg-3 mb-2">
											<div class="d-flex align-items-center">
												...
												<div class="symbol symbol-40 symbol-light mr-4">
													<span class="symbol-label bg-hover-white">
														<img src="${pageContext.request.contextPath}/resources/assets/media/svg/misc/008-infography.svg" class="h-50 align-self-center" />
													</span>
												</div>
												<!--end::Symbol-->
												<!--begin::Text-->
										...
										<div class="list-item hoverable p-2 p-lg-3 mb-2">
											<div class="d-flex align-items-center">
												...
												<div class="symbol symbol-40 symbol-light mr-4">
													<span class="symbol-label bg-hover-white">
														<img src="${pageContext.request.contextPath}/resources/assets/media/svg/misc/007-disqus.svg" class="h-50 align-self-center" />
													</span>
												</div>
												<!--end::Symbol-->
												<!--begin::Text-->
							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h2 class="subheader-title text-dark font-weight-bold my-1 mr-3">Buttons</h2>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
									...
									<a class="font-weight-bold" href="https://getbootstrap.com/docs/4.5/components/buttons/" target="_blank">Bootstrap Documentation</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Row-->
								<div class="row">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example mb-10">
													<p>Bootstrapâs button styles can be applied to other elements, such as labels, to provide checkbox or radio style button toggling.</p>
													<div class="example-preview">
													...
													<div class="example-preview">
														...
														<div class="btn btn-light-success d-inline-flex align-items-center btn-lg mr-5">
															...
															<span class="symbol symbol-40">
																<img alt="Pic" src="${pageContext.request.contextPath}/resources/assets/media/users/300_25.jpg" />
															</span>
														</div>
													</div>
													<div class="example-code">
												...
												<div class="example mb-15">
													...
													<div class="example-preview">
														...
														<p>
															<a href="#" class="btn btn-success btn-sm mr-3">
															<span class="svg-icon">
																<!--begin::Svg Icon | path:${pageContext.request.contextPath}/resources/assets/media/svg/icons/Communication/Call.svg-->
																<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																	<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																		<rect x="0" y="0" width="24" height="24" />
															...
															<a href="#" class="btn btn-danger btn-lg">
															<span class="svg-icon">
																<!--begin::Svg Icon | path:${pageContext.request.contextPath}/resources/assets/media/svg/icons/Design/Flatten.svg-->
																<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																	<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																		<rect x="0" y="0" width="24" height="24" />
