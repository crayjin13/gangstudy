...
<title>GangStudy:이용약관</title>
</head>
<body>
	<form action="" id="joinForm">
		<h3>이용약관</h3>
		<ul class="join_box">
			<li class="checkBox check01"> 제 1 장 총 칙</li>

			<textarea cols="90" rows="8" name="" id="">
 
제 1 조 (목적)
이 약관은 갱스터디(이하 "사이트"라 합니다)에서 제공하는 인터넷서비스(이하 "서비스"라 합니다)의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을 목적으로 합니다.
...
제 2 장 서비스 이용계약
			...
			<textarea cols="90" rows="8" name="" id=""> 제 4 조 (이용계약의 성립)
...
회원은 이용 신청시에 기재했던 회원정보가 변경되었을 경우에는, 온라인으로 수정하여야 하며 변경하지 않음으로 인하여 발생되는 모든 문제의 책임은 회원에게 있습니다.
			...
			<li class="checkBox check01">제 3 장 계약 당사자의 의무</li>
			<textarea cols="90" rows="8" name="" id=""> 제 8 조 (사이트의 의무)
...
제 4 장 서비스 제공 및 이용
			...
			<textarea cols="90" rows="8" name="" id="">제 10 조 (회원 아이디(ID)와 비밀번호 관리에 대한 회원의 의무)
...
② 사이트는 제1항의 규정에 의하여 서비스의 이용을 제한하거나 정지할 때에는 그 사유 및 제한기간 등을 지체없이 회원에게 알려야 합니다.
			...
			<li class="checkBox check01">제5장 계약사항의 변경, 해지
</li>

			<textarea cols="90" rows="8" name="" id="">제 12 조 (정보의 변경)
...
제6장 손해배상
			...
			<textarea cols="90" rows="8" name="" id=""> 제 14 조 (면책조항)
...
서비스와 관련하여 사이트와 회원간에 분쟁이 발생할 경우 사이트의 본사 소재지를 관할하는 법원을 관할법원으로 합니다.
		...
		<li class="checkBox check01">제7장 오프라인매장 이용규칙
 </li>

			<textarea cols="90" rows="8" name="" id=""> 제 16 조(이용규칙)
① 오프라인매장은 범죄예방 목적으로 CCTV가 항시 촬영되고 있습니다.
② 시설이용 시 기물을 절도 또는 파손시 손해배상을 청구할 수 있습니다.
③ 이용요금은 선불로 운영되며, 지불시간 이상 사용할시 퇴거 또는 추가 요금을 요구 할 수 있습니다. 
