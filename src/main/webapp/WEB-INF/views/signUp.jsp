...
<form action="index.html" id="form1">
	<body>
		<!-- header -->
		<div id="header">
			<a href="http://www.gangstudy.com" target="_blank"
				title="GangStudy_signUp"><img src="/images/logo.png" id="logo"></a>
		</div>
			...
			<div id="content">
				...
				<div>
					...
					<span class="box int_pass_check"> <input type="text"
						...
						src="/images/m_icon_check_disable.png" id="pswd2_img1"
						class="pswdImg">
					</span> <span class="error_next_box"></span>
				</div>
				...
				<div class="btn_area">
					<!--   <button type="button" onclick= "location.href='index.html'" id="btnJoin"> -->
					<!--  <form action='http://www.gangstudy.com/'>  -->
