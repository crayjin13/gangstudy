...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>리모컨 이용방법 | Gangstudy</title>
	...
	<div>					<%@ include file="/WEB-INF/views/partials/_header.jsp"%>				</div>
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="d-flex flex-column-fluid">
							<!--begin::Container-->
							<div class="container">																					<!--begin::Form-->       								<form class="form"  >    							
								<div class="card-footer ">									<div class="alert-text "										style="text-align: center; float: none; margin: auto;">									     																					 <p class="myinfo_text col-md-10 d-none d-xl-block" >리모컨 이용방법</p>									<p class="mobile_myinfo_text col-md-9 d-xl-none">리모컨 이용방법</p>										<br>									</div>     								</div>								
								<!--begin::Card-->								<div class="card card-custom card-stretch example example-compact" id="kt_page_stretched_card">								<div class="card-body">
									   											           				    							    							<div class=" row pt-8 pl-2">      										<div class="remo_txt col-md-6 ">리모컨 기능으로 더욱더 편리하게!    </div> 									</div>           									<div class="pl-2 mt-5">  								<p>갱스터디 홈페이지 회원가입 & 로그인 후 문 열기&잠금, 냉난방 시스템 온도 설정등 핸드폰으로 리모컨처럼 이용가능합니다. </p>																								   </div>										   										   										   										   										   										   										   										   										   										   										   										   										   										   										   										   										   										   										   										   										   										   										   										
									</div>
								</div>
								<!--end::Card-->
					</form>     							</div>
