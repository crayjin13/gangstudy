	...
	<div>					<%@ include file="/WEB-INF/views/partials/_header.jsp"%>				</div>
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="d-flex flex-column-fluid">
							<!--begin::Container-->
							<div class="container">																					<!--begin::Form-->       								<form class="form"  >    							
								<div class="card-footer ">									<div class="alert-text "										style="text-align: center; float: none; margin: auto;">																													<p class="myinfo_text col-md-10 d-none d-xl-block">갱스터디 환불기준</p>											<p class="mobile_myinfo_text col-md-9 d-xl-none">갱스터디 환불기준</p>										<br>									</div>     								</div>								
								<!--begin::Card-->								<div class="card card-custom card-stretch example example-compact" id="kt_page_stretched_card">								<div class="card-body">
									   											           																		<div class=" row pt-8 pl-2">      										<div class="remo_txt col-md-6 ">내일 이후에 예정된 스터디룸 취소하면?    </div> 									</div>           									<div class="pl-2 pt-3 mt-5">        								<p>1. 취소하려는 예약이 내일 이후라면, 위약금 없이 전액을 환불해 드립니다.<br>2. 예약금을 계좌이체 하셨다면, 취소 후 환불받으실 계좌번호를 알려주세요. 바로 전액을 재입금해 드립니다. <br>3.충전식 금액권 카드의 충전금액으로 예약하셨다면 다시 전액을 원복해 드립니다. </p>																					<div class=" row pt-8 pl-2">      										<div class="remo_txt col-md-6 "> 오늘 예정인 스터디룸 취소하면?   </div> 									</div>           									<div class="pl-2 mt-5">							<p>1.취소하려는 예약이 오늘이고, 아직 시작시간 전이라면, 50%의 위약금이 발생합니다.<br>2.예약금을 계좌이체 하셨다면, 취소 후 환불받으실 계좌번호를 알려주세요. 50%의 금액을 재입금해 드립니다.   <br>3.충전식 금액권 카드의 충전금액으로 예약하셨다면 50%의 금액만 원복해 드립니다.</p><br>									</div> 																	<div class=" row pt-8 pl-2">      										<div class="remo_txt col-md-6 ">시작시간이 지난 스터디룸 취소하면?   </div> 									</div> 									<div class="pl-2 mt-5">														<p>1.No Show의 경우 입니다. 이런 경우 위약금이 100%이며 환불받으실 금액은 없게 됩니다. <br>2.예약내용이 변경되거나 취소되는 경우 바로바로 저희에게 알려주시거나, 네이버예약의 경우 직접 변경/취소하시기 바랍니다.</p><br>									  																		</div> 																		 																					<div class=" row pt-8 pl-2">      										<div class="remo_txt col-md-6 "> 예약 변경은 기존 예약 취소 후 신규예약 입력으로 간주합니다.    </div> 									</div>           									<div class="pl-2 pt-3 mt-5">  							<p>1.예약 변경의 경우도 예약 취소와 동일한 위약규정을 적용합니다.<br>2.이용예정일 전날 이전 변경시 위약금이 발생하지 않습니다.<br>3.이용예정일에 이용시각 이전 변경시 50%의 위약금이 발생합니다.<br>  4.이용 예정일시가 경과한 후 변경시에는 100%의 위약금이 발생합니다.</p><br>									</div> 																				     							    </div>							  																																																																																																																																							
									</div>
								</div>
								<!--end::Card-->
					</form>     							</div>
