	...
	<div>					<%@ include file="/WEB-INF/views/partials/_header.jsp"%>				</div>
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="d-flex flex-column-fluid">
							<!--begin::Container-->
							<div class="container">																					<!--begin::Form-->       								<form class="form"  >    							
								<div class="card-footer ">									<div class="alert-text "										style="text-align: center; float: none; margin: auto;">																			<p class="myinfo_text col-md-10 d-none d-xl-block">유의사항</p>											<p class="mobile_myinfo_text col-md-9 d-xl-none">유의사항</p>																														<br>									</div>     								</div>								
								<!--begin::Card-->								<div class="card card-custom card-stretch example example-compact" id="kt_page_stretched_card">								<div class="card-body">
									   											           											   							<div class=" row pt-8 pl-2">      										<div class="remo_txt col-md-6 "> 갱스터디 유의사항    </div> 									</div>           									<div class="pl-2 mt-5">    											<p>												 1. 퇴실시 기본정리(쓰레기, 의자, 사용하신 물품 제자리)는 선택사항이 아닌 필수 사항													입니다.<br> 													&nbsp;&nbsp;&nbsp;정리상태가 지나치게 부족하여 다음 이용자의 불만이 접수 될 경우,할인혜택의 제한 또는													할증료(500원/1인1시간) 부과 될 수 있으므로,<br> 													&nbsp;&nbsp;&nbsp;모두에게 쾌적한 이용환경을 위해 불편하시겠지만 많은													협조 부탁드립니다.  <br> 																										2. 대리 신청 및 학생이 아닌 이용자가 이용할 경우 사용에 제한이 있을 수 있습니다.(명의 도용시 법적												조치)<br>												3. 예약시간 및 사용시간 등을 준수하여 주시기 바랍니다. <br>													4. 시설안전 및 화재예방을 위해 24시간 CCTV를 운영하고 있습니다. <br>											</p>													        											       																							  										</div>										   										   										   										   										   										   										   										   										   										   										   										   										   										   										   										   										   										   										   										   										   										   										   										
									</div>
								</div>
								<!--end::Card-->
					</form>     							</div>
