...
String callback = "01058093031";    // [필수] 발신번호 - 숫자만
String phone = "01021367733";       // [필수] 수신번호 - 여러명일 경우 |로 구분 "010********|010********|010********"
String msg = "[* 갱스터디 *] 침입자 발견 !  즉시 지원 바랍니다. ";   // [필수] 문자내용 - 이름(names)값이 있다면 [*이름*]가 치환되서 발송됨
