						...
						<div class="login-form">
							...
							<form class="form" id="kt_login_singin_form" action="">
								...
								<div class="pb-5 pb-lg-15">
									...
									<div class="text-muted font-weight-bold cafe24 font-size-h4">뭐야, 처음이야?
									<a href="custom/pages/login/login-4/signup.html" class="text-primary cafe24 font-weight-bolder">그럼 가입하기 </a></div>
								</div>
								<!--begin::Title-->
								<!--begin::Form group-->
								...
								<div class="form-group">
									<div class="d-flex justify-content-between mt-n5">
										...
										<a href="${pageContext.request.requestURI} : /forgot" class="text-primary cafe24 font-size-h6 font-weight-bolder text-hover-primary pt-5">아, 비밀번호 뭐였더라?</a>
									</div>
