...
<style>  @font-face {     font-family: 'Cafe24Oneprettynight';    src: url('https://cdn.jsdelivr.net/gh/projectnoonnu/noonfonts_twelve@1.1/Cafe24Oneprettynight.woff') format('woff');    font-weight: normal;    font-style: normal;}</style>
	...
	<head><base href="../../../../">
		...
		<!--end::Layout Themes--> 
		<link rel="shortcut icon" href="resources/assets/media/logos/logo-g1.png" /> 
	</head>
	<!--end::Head--> 
	<!--begin::Body-->
	<body id="kt_body" class="header-mobile-fixed subheader-enabled aside-enabled aside-fixed aside-secondary-enabled page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid">
				...
				<!--begin::Content-->
				<!--begin::Aside-->
				<div class="login-aside order-1 order-lg-2 bgi-no-repeat bgi-position-x-right" style="background-image: url(resources/assets/media/bg/forgot.png);">
