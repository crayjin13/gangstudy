...
<html>
   ...
   <link rel="icon" href="/favicon.ico" type="image/x-icon"> 
		...
		<link href="resources/assets/css/themes/layout/brand/light.css" rel="stylesheet" type="text/css" />
		<link href="resources/assets/css/themes/layout/aside/light.css" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize page-loading">
		...
		<jsp:include page="/WEB-INF/views/partials/_extras/offcanvas/quick-cart.jsp"  flush="true"/>

		<jsp:include page="/WEB-INF/views/partials/_extras/offcanvas/quick-panel.jsp"  flush="true"/>

		<jsp:include page="/WEB-INF/views/partials/_extras/chat.jsp"  flush="true"/>

		<jsp:include page="/WEB-INF/views/partials/_extras/scrolltop.jsp"  flush="true"/>
		<jsp:include page="/WEB-INF/views/partials/_extras/toolbar.jsp" flush="true"/>

		<jsp:include page="/WEB-INF/views/partials/_extras/offcanvas/demo-panel.jsp"  flush="true"/> 
		<script>
