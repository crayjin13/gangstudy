    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M3,5 L21,5 C21.5522847,5 22,5.44771525 22,6 L22,16 C22,16.5522847 21.5522847,17 21,17 L3,17 C2.44771525,17 2,16.5522847 2,16 L2,6 C2,5.44771525 2.44771525,5 3,5 Z M4.5,8 C4.22385763,8 4,8.22385763 4,8.5 C4,8.77614237 4.22385763,9 4.5,9 L13.5,9 C13.7761424,9 14,8.77614237 14,8.5 C14,8.22385763 13.7761424,8 13.5,8 L4.5,8 Z M4.5,10 C4.22385763,10 4,10.2238576 4,10.5 C4,10.7761424 4.22385763,11 4.5,11 L7.5,11 C7.77614237,11 8,10.7761424 8,10.5 C8,10.2238576 7.77614237,10 7.5,10 L4.5,10 Z" fill="#000000"/>
								...
								<div class="form-group">
									<label> 시작 시간</label> <input class="form-control" type="datetime-local"  id="example-datetime-local-input">
								</div>
								<div class="form-group">
									<label> 종료 시간</label> <input class="form-control" type="datetime-local"  id="example-datetime-local-input">
								</div>
								<div class="form-group">
									<label for="exampleTextarea">인원수</label>
								...
								<div class="form-group">
									...
									<button type="button" class="btn btn-outline-primary btn-lg btn-block mr-2 ">예약 하기</button>
								</div>
								<div class="form-group">
							 
								
									<button type="button" class="btn btn-outline-secondary btn-lg btn-block mr-2 ">이용하기 </button>
								</div>
								
								<div class="form-group">
								
									<button type="button" onclick="location.href='http://pf.kakao.com/_xbgCJxb'" class="btn btn-outline-warning btn-lg btn-block mr-2 "> 카톡으로 문의하기 </button>
								</div>
								<!--begin: Code-->
